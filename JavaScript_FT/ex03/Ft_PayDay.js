...
function Class (product, TypeOfPayment)
{
    if (TypeOfPayment === 'Money' || TypeOfPayment === 'Pix'  )
    {
        //Money = 15%
        return ("Total: $" + (product - 0.15 * product).toFixed(2));
    }
    else if (TypeOfPayment === 'Debit')
    {
    //Debi = 10%
        return ("Total: $" + (product - 0.10 * product).toFixed(2));
    }
    else if (TypeOfPayment === 'Credit2x')
    {
        //Credit2x = 0
        return ("Total: $" + product.toFixed(2));
    }
    else 
    {
        //CreditMore = 10%;
...
function main ()
{
    ...
    console.log (Class(product, TypeOfPayment));
}
